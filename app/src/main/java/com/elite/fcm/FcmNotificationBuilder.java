...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AAAAFoUfQbo:APA91bGSqM-ZM7To92-q10krVLlqnE3p-V1ny6B2pDjE2FrweClSIMSsqOSqLt6ujyzVyghMhTodGpBeZiQbtSq-F1cOLfpSlaf2jvzDCBj1fb_d0WIgx7QiWDFQmEA9EbpMThm1o-3g";
    private static final String CONTENT_TYPE = "Content-Type";
    private static final String APPLICATION_JSON = "application/json";
    private static final String AUTHORIZATION = "Authorization";
    private static final String AUTH_KEY = "key=" + "AAAA3bB2Oc8:APA91bHCqMWsYJ4nYCU6oYV-Jg7idwKFm8EHmf68uKZK8FgvGfKBI3DRMiQnbMOuUZtK_RKDlw_KpTwV8mojsup98LpQfuiBUEDVxQmltLTbw9BYZ23SZT1K5dLdF6zswJE8j9SS9Q96";
