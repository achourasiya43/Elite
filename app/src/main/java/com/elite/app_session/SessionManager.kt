...
class SessionManager(private val _context: Context){
    ...
    val authToken: String
        get() = mypref.getString("authToken", "")

    val isFirebaseLogin: Boolean
        get() = mypref.getBoolean(IS_FIrebaseLogin, false)
    ...
    val getIsNotifyStauts:String
    get() = mypref2.getString(IsNotificationActive,"")


    val getOldPassword:String
    get() = mypref2.getString(OldPassword,"")
